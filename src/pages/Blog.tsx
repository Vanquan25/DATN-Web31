    ...
    return (
        <div>
            <main>
                ...
                <section className="breadcrumb-area pt-180 pb-180 pt-md-120 pb-md-120 pt-xs-100 pb-xs-100 bg-fix" data-overlay="black" data-opacity={7} data-background="/src/templace/img/bg/breadcrumb-bg-2.jpg">
