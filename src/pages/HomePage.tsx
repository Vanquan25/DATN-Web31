      ...
      <main>
          ...
          <div className="swiper-container home-slider-2">
            ...
            <div className="swiper-wrapper">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('./src/templace/img/slider/slider-2.jpg')",
                }}
              >
            ...
            <div className="row justify-content-center">
              <div className="col-xl-7 col-lg-8">
                <div className="section-title-3 text-white text-center mb-70">
                  ...
                  <p>
                    Luyện tập tại GYM T&amp;T sẽ giúp bạn đạt được mục tiêu sức
                    khỏe và hình thể.
                  </p>
                </div>
              </div>
        ...
        <section className="about-area-2 bg-black pt-130 pb-130">
              ...
              <div className="col-lg-6 col-md-10">
                <div className="about-thumb-wrap text-center mb-30">
                  <div className="about-img-2 mb-70">
                    <img
                      src="/src/templace/img/thumb/thumb-4.jpg"
                      alt="about"
                    />
                  </div>
              ...
              <div className="col-lg-6 col-md-12">
                <div className="about-content-2 pt-35">
                  <div className="section-title-3 text-white">
                    <h3 className="bars">
                      Chúng Tôi Luôn Cố Gắng Để Mang Lại Trải Nghiệm Tốt Nhất
                    </h3>
                  </div>
                  <div className="about-text mb-45"></div>
                  <div className="about-video-play">
                    <img
                      src="/src/templace/img/thumb/thumb-5.jpg"
                      alt="thumb"
                    />
                    <a
                      href="https://www.youtube.com/watch?v=ZIKt1-r3PL0"
                      className="popup-video read-more"
                    >
          ...
          <div className="about-shape">
            <img
              className="rotateme"
              src="/src/templace/img/shape/shape-5.png"
              alt="shape"
            />
          </div>
        </section>
        <div className="schedule-area-2 bg-black pt-130 pb-130">
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="section-title-2 bar-theme-color text-white text-center mb-35">
                  <h3>Sắp Xếp Lịch Trình Luyện Tập</h3>
                  <span>GymT&amp;T</span>
                </div>
              </div>
            </div>
          ...
          <div className="schedule-shape-3">
            <img
              className="rotateme"
              src="/src/templace/img/shape/shape-10.png"
              alt="shape"
            />
          </div>
        </div>
        ...
        <div className="calculator-area-2 pt-130 pb-100">
            ...
            <div className="row justify-content-center align-items-center">
              ...
              <div className="col-xl-4 col-lg-5 offset-lg-1">
                <div className="calculator-form-2">
                  <h3>Bảng Tính BMI</h3>
                  <p>Tính Chỉ Số Để Xem Tình Trạng Sức Khỏe Hiện Tại Của Bạn</p>
          ...
          <div
            className="calculator-bg-1 bg-fix"
            style={{
              backgroundImage:
                "url('./src/templace/img/bg/calculator-bg-1.jpg')",
            }}
          />
          <div
            className="calculator-bg-2 bg-fix"
            style={{
              backgroundImage:
                "url('./src/templace/img/bg/calculator-bg-2.jpg')",
            }}
          />
        </div>
        {/* calculator-area end */}
            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-xl-12">
                <div className="section-title-2 text-white bar-theme-color text-center mb-35">
                  <h3>
                    Chúng Tôi Sẽ Mang Lại Những Dịch Vụ Tốt Nhất Để Làm Hài Lòng
                    Khách Hàng
                  </h3>
                  <span>GymT&amp;T</span>
                </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-7">
                <div className="pricing-wrap mt-30 mb-30">
                  <h3>Basic</h3>
                  <p>
                    Bobis est eligendi optio cumque nihil impedit quo minus id
                    quod maxime placeat facere possimus, omnis volup tas
                    assumenda est omnis dess
                  </p>
                  ...
                  <div className="shape">
                    <img
                      src="/src/templace/img/shape/shape-11.png"
                      alt="shape"
                    />
                  </div>
                </div>
        ...
        <div
          className="testimonial-area-2 pt-130 pb-130"
          style={{
            backgroundImage:
              "url('./src/templace/img/bg/testimonial-bg-2.jpg')",
          }}
          data-overlay="black"
          data-opacity={8}
        >
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="section-title-2 text-center text-white bar-theme-color mb-35">
                  <h3>Đánh Giá Của Khách Hàng Về Dịch Vụ</h3>
                  <span>GymT&amp;T</span>
                </div>
              </div>
            </div>
                ...
                <div className="swiper-container testimonial-thumbs-2 mb-50">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <img
                        src="/src/templace/img/author/author-lg-1.jpg"
                        alt="author"
                      />
                    </div>
                    <div className="swiper-slide">
                      <img
                        src="/src/templace/img/author/author-lg-2.jpg"
                        alt="author"
                      />
                    </div>
                    <div className="swiper-slide">
                      <img
                        src="/src/templace/img/author/author-lg-3.jpg"
                        alt="author"
                      />
                    </div>
                    <div className="swiper-slide">
                      <img
                        src="/src/templace/img/author/author-lg-4.jpg"
                        alt="author"
                      />
                    </div>
                  </div>
                      ...
                      <div className="swiper-slide single-slide">
                        <div className="testimonial-wrap-2">
                          <div className="testimonial-content">
                            <p>
                              Một thương hiệu quen thuộc với những dòng sản phẩm
                              cao cấp, chuyên nghiệp. Những sản phẩm của thương
                              hiện này được giới chuyên môn đánh giá cao. Bên
                              cạnh dòng công suất lớn dành phòng phòng gym dịch
                              vụ thì thương hiệu SPIRIT cũng có thêm dòng dành
                              cho phân khúc home gym cao cấp. Những sản phẩm
                              dòng này thường sẽ được Gymaster tư vấn đối với
                              những dự án setup phòng gym tại nhà có ngân sách
                              lớn.
                            </p>
                          </div>
        ...
        <div className="blog-area bg-black pt-130 pb-100">
          <div className="container">
            <div className="row">
              <div className="col-xl-12">
                <div className="section-title-2 text-white bar-theme-color text-center mb-35">
                  <h3>Những Bài Viết Chia Sẻ về Sức Khỏe Và Bài Tập</h3>
                  <span>GymT&amp;T</span>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-xl-4 col-md-6">
                <div
                  className="blog-wrap mb-30"
                  style={{
                    backgroundImage:
                      "url('./src/templace/img/blog/blog-1.jpg')",
                  }}
                >
                  <div className="blog-author mb-40">
                    <div className="author-thumb">
                      <img
                        src="/src/templace/img/author/author-2.jpg"
                        alt="Author"
                      />
                    </div>
                  ...
                  <div className="blog-meta">
                    <span>
                      <i className="fas fa-calendar-alt" /> 20 Jan 2020
                    </span>
                    <span>
                      <i className="far fa-comments" /> Comments (1k)
                    </span>
                  </div>
              ...
              <div className="col-xl-4 col-md-6">
                ...
                >
                  <div className="blog-author mb-40">
                    <div className="author-thumb">
                      <img
                        src="/src/templace/img/author/author-3.jpg"
                        alt="Author"
                      />
                    </div>
                    <div className="author-content">
